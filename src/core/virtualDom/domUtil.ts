...
export const makeReplaceAction = function(index: number, item: common.TObject): common.TListDiffAction {
  return {
...
export const makeUpdatePropsAction = function(index: number, props: common.TLvl1JSON): common.TListDiffAction {
  return {
